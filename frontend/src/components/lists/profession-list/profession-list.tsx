  ...
  return (
    <div className={styles.container}>
      ...
      <ul className={styles.wrapper__list}>
        <span className={styles.opacity}>Численность по КЛС</span>
        <Border />
      ...
      <ul className={styles.wrapper__list}>
        {(type === activeShift || !type) && (
          <span className={styles.opacity}>Сегодня работают</span>
        )}
        {type === finishedShift && (
          <span className={styles.opacity}>Работали в смене</span>
        )}
        <Border />
      ...
      {addedProfessions.length > 0 && (
        <ul className={styles.wrapper__list}>
          <span className={styles.opacity}>Дополнительно вышли</span>
          <Border />
      ...
      <ul className={styles.wrapper__list}>
        {(type === activeShift || !type) && (
          <span className={styles.opacity}>Сегодня отсутствуют</span>
        )}
        {type === finishedShift && (
          <span className={styles.opacity}>Отсутствовали в смене</span>
        )}
        <Border />
