...
export const PackChart = ({ shiftId, list }: IChartProps) => {
        ...
        <>
          ...
          <div className={styles.wrapper__count}>
            ...
            <div className={styles.wrapper__footer}>
              ...
              <span className={styles.total__size}>{getCount(packs)} рул</span>
            </div>
          </div>
              ...
              {packerLocations.length > 0 ? (
                packerLocations.map((item, index) => (
                  <li className={styles.wrapper} key={index}>
                    ...
                    <span className={styles.worker__count}>{item.count}</span>
                  </li>
                ))
              ) : (
